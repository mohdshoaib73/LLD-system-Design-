...
*/ 
/*
in this example Car is parent class with 2 child classes ManualCar and ElectricCar.
we use abstract methods accelerate() and brake() in parent class Car.
Both ManualCar and ElectricCar provide their own implementation of these methods.
*/
class Car {
protected:
    string brand;
...
public:
    ...
    virtual ~Car() {}               // Virtual destructor it is use to free derived class objects properly
};
...
public:
    ManualCar(string brand, string model) : Car(brand, model) {// Calling Parent class constructor
        this->currentGear = 0;
    }
...
// Main function
int main() {
    Car* myManualCar = new ManualCar("Toyota", "Fortuner Legender");
    ...
    Car* myElectricCar = new ElectricCar("Tata", "Nexon EV");
