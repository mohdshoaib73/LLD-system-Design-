...
*/
/* Static Polymorphism in C++ is achieved through function overloading or operator overloading.
   At compile time, the compiler determines which version of the overloaded function to call
   based on the number, types, and order of arguments passed. */
